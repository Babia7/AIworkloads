          ...
          <div className="bg-slate-900 rounded-2xl p-8 border border-slate-800 relative overflow-hidden group hover:border-blue-500/30 transition-colors">
            ...
            <div className="relative z-10">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        <h3 className="text-2xl font-bold text-white">RDMA</h3>
                        <p className="text-blue-400 text-sm font-semibold uppercase tracking-wider">Remote Direct Memory Access</p>
                    </div>
                </div>

                <p className="text-slate-300 mb-8 leading-relaxed">
                    RDMA allows data to be transferred directly into the memory of a remote computer without involving the processor, cache, or operating system of either system. This "Zero-Copy" approach significantly reduces latency and releases resources for the actual application (AI Training).
                </p>
                ...
                <ul className="space-y-3">
                    {CORE_CONCEPTS[0].features.map((feature, i) => (
          ...
          <div className="bg-slate-900 rounded-2xl p-8 border border-slate-800 relative overflow-hidden group hover:border-purple-500/30 transition-colors">
            ...
            <div className="relative z-10">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        <h3 className="text-2xl font-bold text-white">NVMe</h3>
                        <p className="text-purple-400 text-sm font-semibold uppercase tracking-wider">Non-Volatile Memory Express</p>
                    </div>
                </div>

                {/* Original NVMe Context */}
                <p className="text-slate-300 mb-6 leading-relaxed">
                    A storage interface protocol designed to accelerate the transfer of data between enterprise and client systems and solid-state drives (SSDs). It utilizes high-speed <GlossaryTerm term="PCIe">PCIe</GlossaryTerm> lanes to maximize parallelism.
                </p>
                ...
                <ul className="space-y-3">
                    {CORE_CONCEPTS[1].features.map((feature, i) => (
                        <li key={i} className="flex items-center gap-3 text-slate-300">
