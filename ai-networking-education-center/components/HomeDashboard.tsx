      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
           <div className="flex flex-wrap justify-center gap-8 text-sm font-medium text-slate-500">
              <a href="#performance" onClick={(e) => handleScroll(e, '#performance')} className="flex items-center gap-2 hover:text-blue-400 transition-colors cursor-pointer z-30">
                <Zap size={16} /> Ultra Low Latency
              </a>
              <a href="#protocols" onClick={(e) => handleScroll(e, '#protocols')} className="flex items-center gap-2 hover:text-indigo-400 transition-colors cursor-pointer z-30">
                <Network size={16} /> Lossless Fabric
              </a>
              <a href="#etherlink" onClick={(e) => handleScroll(e, '#etherlink')} className="flex items-center gap-2 hover:text-cyan-400 transition-colors cursor-pointer z-30">
