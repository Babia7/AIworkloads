...
import { 
  CircuitBoard, Server, Network, ShieldCheck, Activity, Zap, Layers, Globe, Radio, GitMerge, AlertCircle, ArrowLeftRight, Database, Cpu, Leaf, Palette, Code, Lightbulb, Grid, Home, Layout, GitCompare, BarChart2, HardDrive, Rocket, Microscope, Terminal, BookOpen, Smartphone, Search, Download, Eye, Keyboard, Settings, Lock, Check, X, Save, Trash2, Plus, RotateCcw, LogOut, Edit2, Moon, Sun, Type, MousePointer, Maximize, Minimize, List, CheckSquare, Video, Mic, Cloud, Flag, Share2
} from 'lucide-react';
...
export const PRODUCTS = [
  {
    ...
    variants: [
        ...
        { name: "7060X5 Series", chip: "Tomahawk", capacity: "25.6T", ports: "32x 800G", formFactor: "1RU/2RU" }
    ]
  },
  {
    id: '7800R',
    ...
    variants: [
        { name: "7800R4-AI", chip: "Jericho", capacity: "28.8T/slot", ports: "36x 800G", formFactor: "Linecard" },
        { name: "7800R3A", chip: "Jericho", capacity: "14.4T/slot", ports: "36x 400G", formFactor: "Linecard" },
        { name: "16-Slot Chassis", chip: "N/A", capacity: "460T", ports: "576x 800G", formFactor: "16-Slot" }
    ]
  },
  {
    id: '7700R',
